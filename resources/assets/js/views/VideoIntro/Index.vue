...
<script type="text/javascript">
    ...
    import { handleErrorResponse, scrollToTop } from '../../helpers/helper'
    ...
    export default {
        ...
        created() {
            get(this.$router.options.base+'api/video-intros').then((res) => {
        ...
        mounted() {
            ...
            Event.listen('delete', function (key) {
                if (confirm("Are you sure to delete this?")) {
                    var id = this.intros[key].id;
                    del(window.base_url+'api/video-intros/'+id).then((res) => {
                        if(res.data.deleted) {
